...
# ============================
SESSION = environ.get('SESSION', 'NobaraIQ')   # Session name for the bot
...
BOT_TOKEN = environ.get('BOT_TOKEN', "8448962977:AAGqaEbtf2V0VJ87nuHPoXyECNhUJLugQeI")    # Bot token from @BotFather
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '2067321568')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002758990595')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/anyalibertsupport')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1003410324009")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
...
LANGUAGES = {"Japanese":"jap","English":"eng","Korean":"kor","Chinese":"chi"}
